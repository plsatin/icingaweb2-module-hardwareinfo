...
"@)
    ...
    $apiurl = "https://icinga2.satin-pl.com:5665/v1/objects/hosts/" + $hostname
...
function Get-ServiceFromIcinga {
    ...
    $apiurl = 'https://icinga2.satin-pl.com:5665/v1/objects/services?service=' + $hostname + '!' + $servicename
